...
The LeakDetector maintainers takes security seriously.
...
See [CODE_OF_CONDUCT.md](https://github.com/duyquang91/LeakDetector/blob/master/CODE_OF_CONDUCT.md) for details.
